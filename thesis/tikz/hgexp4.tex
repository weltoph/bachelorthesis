\begin{tikzpicture}[node distance=2 and 2]
	\node[node] (r)  {$1$};
	\node[var, blue!50] (curr) [above=of r] {$\mathit{curr}$};
	\node[node] (r-l) [below left=of r] {$1$};
	\node[node] (r-r) [below right=of r] {};
	\node[node, node distance=2 and 1.2] (r-l-l) [below left=of r-l] {$2$};
	...
	\draw [sel, blue!50] (r-l) to node[left]{$l_{\mathit{WR}}$} (r-l-l);
